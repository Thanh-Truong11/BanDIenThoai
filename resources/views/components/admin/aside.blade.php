<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 px-1" href="{{ url('/admin') }} " >
            <h3 class="ms-1 font-weight-bold text-white" class="text-white">TIENTHANH</span><span
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('admin.orders.index') }}">
                    ...
                    <span class="nav-link-text ms-3"> Các đơn hàng
                    </span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ url('/admin/danh-muc/danh-sach') }}">
                    ...
                    <span class="nav-link-text ms-3">Danh mục </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ url('/admin/san-pham') }}">
                    ...
                    <span class="nav-link-text ms-3">Sản phẩm</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ route('vouchers.index') }}">
                    ...
                    <span class="nav-link-text ms-3">Voucher</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ url('/admin/thuoc-tinh/danh-sach') }}">
                    ...
                    <span class="nav-link-text ms-3 ">Thuộc tính</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ url('/admin/loai-bai-viet/danh-sach') }}">
                    ...
                    <span class="nav-link-text ms-3"> Loại bài viết
                    </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ url('/admin/bai-viet/danh-sach') }}">
                    ...
                    <span class="nav-link-text ms-3"> Bài viết
                    </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ url('/admin/banners/danh-sach') }}">
                    ...
                    <span class="nav-link-text ms-3">Banner</span>
                </a>
            </li>
            {{-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ url('/admin/tai-khoan/danh-sach') }}">
                    ...
                    <span class="nav-link-text ms-3"> Tài khoản
                    </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white " href="{{ url('/') }}">
                    ...
                    <span class="nav-link-text ms-3"> Trang chủ website
                    </span>
                </a>
            </li>
        </ul>
